...
def bro_dictionary
    bro_dictionary = {
        :special_phrases => {
            ...
            "This hat fits very nicely" => "Yo this shell fits my dome piece perfect",
            "please give me a call" => "holler at ur boiiiii!!!!",
            "where are you?" => "where you at?",
            "how are you?" => "you good bro?",
            "you are acting inappropriately" => "seriously bro, you need to chill",
